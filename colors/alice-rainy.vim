...
call s:H('NeoTreeNormalNC', '#CCD2D7', '#30363C', '', 252, 237)
call s:H('NeoTreeFloatNormal', '#CCD2D7', '#30363C', '', 252, 237)
call s:H('NeoTreeFloatBorder', '#8F9396', '#30363C', '', 246, 237)
call s:H('NeoTreeFloatTitle', '#56A0D1', '#30363C', 'bold', 74, 237)
call s:H('NeoTreeTitleBar', '#56A0D1', '#30363C', 'bold', 74, 237)
call s:H('NeoTreeExpander', '#3D454D', '#30363C', '', 238, 237)
call s:H('NeoTreeFileIcon', '#5B7F92', '#30363C', '', 66, 237)
call s:H('NeoTreeFileNameOpened', '#56A0D1', '#30363C', 'bold', 74, 237)
call s:H('NeoTreeDimText', '#3D454D', '#30363C', '', 238, 237)
call s:H('NeoTreeFadeText1', '#3D454D', '#30363C', '', 238, 237)
call s:H('NeoTreeFadeText2', '#3D454D', '#30363C', '', 238, 237)
call s:H('NeoTreeDotfile', '#8F9396', '#30363C', '', 246, 237)
call s:H('NeoTreeHiddenByName', '#8F9396', '#30363C', '', 246, 237)
call s:H('NeoTreeIgnored', '#8F9396', '#30363C', '', 246, 237)
call s:H('NeoTreeFilterTerm', '#BFA065', '#30363C', 'bold', 143, 237)
call s:H('NeoTreeMessage', '#56A0D1', '#30363C', '', 74, 237)
call s:H('NeoTreeModified', '#C49A55', '#30363C', '', 173, 237)
call s:H('NeoTreeSelected', '', '#1F252A', '', "NONE", 235)
call s:H('NeoTreeSignColumn', '', '#30363C', '', "NONE", 237)
call s:H('NeoTreeStatusLine', '#CCD2D7', '#30363C', '', 252, 237)
call s:H('NeoTreeStatusLineNC', '#8F9396', '#30363C', '', 246, 237)
call s:H('NeoTreeVertSplit', '#8F9396', '#30363C', '', 246, 237)
call s:H('NeoTreeBufferNumber', '#8F9396', '#30363C', '', 246, 237)
call s:H('NeoTreeFileStats', '#8F9396', '#30363C', '', 246, 237)
call s:H('NeoTreeFileStatsHeader', '#56A0D1', '#30363C', 'bold', 74, 237)
call s:H('NeoTreePreview', '#CCD2D7', '#30363C', '', 252, 237)
call s:H('NeoTreeWindowsHidden', '#3D454D', '#30363C', '', 238, 237)
call s:H('NeoTreeTabActive', '#56A0D1', '#30363C', 'bold', 74, 237)
call s:H('NeoTreeTabInactive', '#8F9396', '#30363C', '', 246, 237)
call s:H('NeoTreeTabSeparatorActive', '#8F9396', '#30363C', '', 246, 237)
call s:H('NeoTreeTabSeparatorInactive', '#8F9396', '#30363C', '', 246, 237)
