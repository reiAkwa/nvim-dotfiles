...
call s:H('NeoTreeNormalNC', '#3B3B3B', '#DAE2E9', '', 237, 254)
call s:H('NeoTreeFloatNormal', '#3B3B3B', '#DAE2E9', '', 237, 254)
call s:H('NeoTreeFloatBorder', '#787878', '#DAE2E9', '', 243, 254)
call s:H('NeoTreeFloatTitle', '#56A0D1', '#DAE2E9', 'bold', 74, 254)
call s:H('NeoTreeTitleBar', '#56A0D1', '#DAE2E9', 'bold', 74, 254)
call s:H('NeoTreeExpander', '#A8B4C0', '#DAE2E9', '', 249, 254)
call s:H('NeoTreeFileIcon', '#5B7F92', '#DAE2E9', '', 66, 254)
call s:H('NeoTreeFileNameOpened', '#56A0D1', '#DAE2E9', 'bold', 74, 254)
call s:H('NeoTreeDimText', '#A8B4C0', '#DAE2E9', '', 249, 254)
call s:H('NeoTreeFadeText1', '#A8B4C0', '#DAE2E9', '', 249, 254)
call s:H('NeoTreeFadeText2', '#A8B4C0', '#DAE2E9', '', 249, 254)
call s:H('NeoTreeDotfile', '#787878', '#DAE2E9', '', 243, 254)
call s:H('NeoTreeHiddenByName', '#787878', '#DAE2E9', '', 243, 254)
call s:H('NeoTreeIgnored', '#787878', '#DAE2E9', '', 243, 254)
call s:H('NeoTreeFilterTerm', '#A57A2E', '#DAE2E9', 'bold', 136, 254)
call s:H('NeoTreeMessage', '#56A0D1', '#DAE2E9', '', 74, 254)
call s:H('NeoTreeModified', '#B58532', '#DAE2E9', '', 137, 254)
call s:H('NeoTreeSelected', '', '#F0F8FF', '', "NONE", 231)
call s:H('NeoTreeSignColumn', '', '#DAE2E9', '', "NONE", 254)
call s:H('NeoTreeStatusLine', '#3B3B3B', '#DAE2E9', '', 237, 254)
call s:H('NeoTreeStatusLineNC', '#787878', '#DAE2E9', '', 243, 254)
call s:H('NeoTreeVertSplit', '#787878', '#DAE2E9', '', 243, 254)
call s:H('NeoTreeBufferNumber', '#787878', '#DAE2E9', '', 243, 254)
call s:H('NeoTreeFileStats', '#787878', '#DAE2E9', '', 243, 254)
call s:H('NeoTreeFileStatsHeader', '#56A0D1', '#DAE2E9', 'bold', 74, 254)
call s:H('NeoTreePreview', '#3B3B3B', '#DAE2E9', '', 237, 254)
call s:H('NeoTreeWindowsHidden', '#A8B4C0', '#DAE2E9', '', 249, 254)
call s:H('NeoTreeTabActive', '#56A0D1', '#DAE2E9', 'bold', 74, 254)
call s:H('NeoTreeTabInactive', '#787878', '#DAE2E9', '', 243, 254)
call s:H('NeoTreeTabSeparatorActive', '#787878', '#DAE2E9', '', 243, 254)
call s:H('NeoTreeTabSeparatorInactive', '#787878', '#DAE2E9', '', 243, 254)
